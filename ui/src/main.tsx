...
// (its Privacy Portal bridge use case). Our facade/vault writes happen on Sepolia,
// so NetworkGuard needs to be told that explicitly or it'll block the UI expecting
// the wrong chain.
configureCotiPlugin({
  walletConnectProjectId: import.meta.env.VITE_WALLETCONNECT_PROJECT_ID,
  debug: import.meta.env.DEV,
  defaultNetworkId: String(SEPOLIA_CHAIN_ID),
})
